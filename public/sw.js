const C='pr-v9';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(C).then(c=>c.addAll(['/','/assets/css/style.css','/assets/js/app.js?v=9','/assets/img/logo.svg','/manifest.webmanifest'])))});
