# Grey-market expansion — batch 1 (2026-09-16).
# BRAND_MAP: every brand from the 340-item list assigned to its compound.
# PENDING: compounds for batches 2-3 (assigned, not yet profiled).
...
# --- steroids (profiled batch 1) ---
 ...
 "winstrol": ["Winstrol","Stanabol","Stanozolol","Stanoplex","Stanoxyl","Stromba","Azolol"],
 "nandrolone": ["Deca","Nandroxyl","NPP","Dynabol"],
 "boldenone": ["EQ","Boldabol","Boldaxyl"],
 "masteron": ["Masteron","Mastabol","Mastaplex","Masteroxyl"],
 "primobolan": ["Primobol","Primobolan","Primoplex","Primoxyl"],
 "proviron": ["Proviron","Mesterolone","Proviraplex","Proviroxyl"],
 "anadrol": ["Anadrol","Anadroxyl","Oxymetholone","Oxydrol","Oxyplex","Ortrexyl"],
 "halotestin": ["Halotest","Halotestin","Halotestex","Haloplex","Haloxyl"],
 "turinabol": ["Turanabol","Turanaplex","Turanaxyl"],
 "superdrol": ["Superdrol"],
 "oral-tren": ["Oral Tren"],
 "trestolone": ["Ment","Trestolone"],
...
# --- peptides (profiled batch 1) ---
 "bpc-157": ["BPC 157"],
 "tb-500": ["TB 500"],
 "melanotan-2": ["Melanotan 2","GLOW","Glow Blend"],
# --- hormones (profiled batch 1) ---
 "hgh": ["Somatropin HGH","AxoTropin HGH","Dragontropin HGH","Kalpatropin HGH","PH-Tropin HGH","Somatrobol HGH"],
...
# --- batch 2: PCT & fertility hormones ---
 ...
 "raloxifene": {"cat":"hair-hormones","brands":["Raloxifene"]},
 "toremifene": {"cat":"hair-hormones","brands":["Toremfine"]},
 "cabergoline": {"cat":"hair-hormones","brands":["Caberlin","Cabgolin"]},
 "hcg": {"cat":"hair-hormones","brands":["Fertigyn","HuCoG"]},
 "hmg": {"cat":"hair-hormones","brands":["HMG","GMH HP"]},
 "minoxidil": {"cat":"hair-hormones","brands":["Minoxidil"]},
# --- batch 2: peptide block ---
 "gh-secretagogues": {"cat":"peptides","brands":["GHRP-2","GHRP-6","Hexarelin","Ipamorelin","Sermorelin","Tesamorelin","Hexyl"]},
 "igf-1": {"cat":"peptides","brands":["IGF-1 LR3","Somedin-DES","Somedin-LR3","PEG MGF"]},
 "pt-141": {"cat":"peptides","brands":["PT-141"]},
 "kisspeptin": {"cat":"peptides","brands":["Kisspeptin"]},
 "mots-c": {"cat":"peptides","brands":["MOTS-C"]},
 "ss-31": {"cat":"peptides","brands":["SS-31"]},
 "thymosin-alpha-1": {"cat":"peptides","brands":["Thymosin Alpha-1"]},
 "epitalon": {"cat":"peptides","brands":["Epitalon"]},
 "ghk-cu": {"cat":"peptides","brands":["GHK-Cu"]},
...
# --- batch 3: weight loss & metabolic ---
 ...
 "t4-levothyroxine": {"cat":"weight-loss","brands":["T4","Eltroxin (T4)","Synthroid T4","Thyrox","Thyronorm","L-Thyroxin"]},
 "orlistat": {"cat":"weight-loss","brands":["Orlistat","Orligal","Xenical"]},
 "sibutramine": {"cat":"weight-loss","brands":["Sibutramine"]},
 "metformin": {"cat":"weight-loss","brands":["Metfor","Glycomet SR","Okamet"]},
 "l-carnitine": {"cat":"weight-loss","brands":["L-Carnitine"]},
 "cagrilintide": {"cat":"weight-loss","brands":["Cagrilintide"]},
 "survodutide": {"cat":"weight-loss","brands":["Survodutide"]},
 "mazdutide": {"cat":"weight-loss","brands":["Mazdutide"]},
 "aod-9604": {"cat":"weight-loss","brands":["AOD 9604"]},
 "adipotide": {"cat":"weight-loss","brands":["Adipotide"]},
# --- batch 3: misc pharma ---
 "isotretinoin": {"cat":"performance","brands":["Accutane","Isotroin","Sotret","Tretiva"]},
 "modafinil": {"cat":"performance","brands":["Modasmart"]},
 "salbutamol": {"cat":"performance","brands":["Salbutamol","Ventolin","Asthalin Respules"]},
 "ketotifen": {"cat":"performance","brands":["Ketasma","Asthafen"]},
