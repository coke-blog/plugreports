...
def shell(path, title, desc, body, jsonld=None, canonical=None, extra_head="", ogimage=None):
    ...
    if path.split("/")[0] in ("busts", "news", "drugs"):
...
<h2>Tap a substance</h2><p>Glass tiles, two rows — scroll sideways. Every profile: effects, risks, overdose signs, street price, legal status, sources.</p></div>
...
<div class="sec-head"><div><span class="kicker">Updates</span><h2>News, busts & guides</h2></div></div>
