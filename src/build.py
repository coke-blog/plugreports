...
<div class="social-row" style="display:flex;gap:12px;flex-wrap:wrap;margin-top:26px">
<a href="https://www.reddit.com/u/plugreports/s/WV01nxBLan" target="_blank" rel="noopener" class="soc-btn"><span style="color:#ff4500">&#9679;</span> Reddit</a>
<a href="https://plugreports.quora.com/" target="_blank" rel="noopener" class="soc-btn"><span style="color:#b92b27">Q</span> Quora</a>
<a href="mailto:contact@plugreports.com" class="soc-btn"><span style="color:#fbbf24">&#9993;</span> contact@plugreports.com</a>
</div>
...
def main():
    ...
    w("_dynamic.html", shell("_dynamic.html", "plugreports",
      ...
      extra_head='<script src="/assets/js/render.js?v=8" defer></script>', canonical=SITE + "/"))
