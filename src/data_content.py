...
BUSTS = [
 dict(slug="bust-adelaide-highgate-trafficking", tag="Alert", country="Australia", title="Adelaide police seize 3 kg cocaine, $72,595 cash, ketamine, MDMA in Highgate trafficking raid", date="2026-09-26",
  confirmed=True, views=200, image="/media/busts/adelaide-highgate-drugs-cash.jpeg",
  location="Highgate, Adelaide, South Australia", agency="South Australia Police — Serious and Organised Crime Branch",
  sourceUrl="https://www.police.sa.gov.au/sa-police-news-assets/front-page-news/drugs-and-cash-seized-at-highgate",
  summary="On Friday 25 September, officers from SAPOL's Serious and Organised Crime Branch searched a property at Highgate, in Adelaide's inner southern suburbs, seizing $72,595 in cash, 3 kilograms of cocaine, 871 grams of ketamine, 385 grams of MDMA and 700 grams of cannabis. A 30-year-old man and a 23-year-old woman were arrested and charged with two counts of trafficking a commercial quantity of a controlled drug, two counts of trafficking a large commercial quantity, and one count of trafficking a controlled drug. Both were refused police bail and were due before the Adelaide Magistrates Court on Monday 28 September. Police also seized a Renault van, a Suzuki SUV and a large amount of jewellery and watches under the Criminal Assets Confiscations Act 2005. Detective Chief Inspector Philip Neagle said the seizure demonstrates SAPOL's commitment to 'targeting those involved in the trafficking of illicit drugs and dismantling the criminal networks behind their distribution.' Adelaide Now describes the pair as alleged organisers of a drug ring operating in the city's wealthy inner-south.",
  sentencing="South Australia: trafficking a large commercial quantity (over 1 kg commercial / over 500 g large commercial for cocaine) carries a maximum of life imprisonment; trafficking a commercial quantity carries up to 25 years. Assets seized under the Criminal Assets Confiscations Act 2005.",
  drugsInvolved=["cocaine","ketamine","mdma","weed"],
  related=["cocaine","ketamine","mdma","bust-vancouver-cocaine-328kg-tshirts"]),
 dict(slug="bust-argentina-mdma-52kg-record", tag="Record", country="Argentina", title="Largest MDMA seizure in Argentine history: 52 kg of max-purity ecstasy hidden in a van from Belgium", date="2026-09-16",
  confirmed=True, views=350, image="/media/busts/argentina-mdma-52kg-pfa.jpeg",
  location="Buenos Aires (Zárate free zone, CABA, Salta), Argentina", agency="Policía Federal Argentina (DFI) + ARCA Customs, with DEA tip-off",
  sourceUrl="https://www.argentina.gob.ar/noticias/la-mayor-incautacion-de-mdma-de-la-historia-argentina-52-kilos-y-tres-detenidos",
  summary="Argentina's Federal Police seized 52 kilograms of maximum-purity MDMA — the largest synthetic-drug seizure in the country's history, worth an estimated US$18 million and enough for roughly one million ecstasy pills. The drugs arrived from Belgium by ship, hidden in a van: 38 plastic bottles holding 20 kg were found in the fuel tank, and 49 nylon-wrapped packages with another 32 kg inside the door panels and side cavities, detected by non-intrusive scanner after the vehicle sat stranded in the Zárate free zone. The investigation began in March 2026 from a DEA alert about a Mexican organisation moving synthetic drugs by sea; an undercover PFA agent infiltrated the group as a logistics facilitator, and GPS trackers were fitted to the van for a monitored delivery before eight raids across Buenos Aires and Salta. Three men were arrested — a Mexican national sent to receive the vehicle, an Argentine handling security and logistics, and a Venezuelan involved in the cash handover (an informal hawala transfer) — and an international arrest warrant was issued for a second Mexican coordinator. InSight Crime notes the record comes amid expanding European MDMA production seeking new markets in the Southern Cone.",
  sentencing="Argentina: drug trafficking (Law 23.737, Article 5) — possession of drugs for commercial purposes carries 4 to 15 years; importing max-purity MDMA for distribution typically draws sentences toward the top of that range under the aggravated commercial-quantity provisions.",
  drugsInvolved=["mdma","xtc-pills"],
  related=["mdma","xtc-pills","topics:mdma-overdose","busts:bust-adelaide-highgate-trafficking"]),
