...
> Snapshot: 2026-09-23 — P2 batch LIVE (17 profiles: nalmefene, methocarbamol, tizanidine, amitriptyline, clonidine, lofexidine, butane-huffing, flunitrazolam, fluclotizolam, thcjd, thch, hhc-o, dipyanone, 5-mapb, 6-mapb, mitragynine, kratom-extracts → 463 total; KV seeded 463; deploy 062921b4; home stats dynamic). Quora queue: quora-queue.md — Q2 (grey GLP-1s) posted OK; Q1/Q3 removed by Quora auto-moderation (potency-comparison + fentanyl-in-title patterns) and reframed policy/pharmacology-safe; lessons documented in the file. 37 profiles short of the 500 press-release milestone — next batch candidates in content-gaps.md. · Read this first in any new session before touching anything.
