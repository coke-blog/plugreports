...
> Snapshot: 2026-09-22 — VS section live (70 comparisons at /vs/, reasons-first SEO on VS+Mix hubs, link audit clean, CF deploy f7630af9, repo main 6da0eb81). P1 trends batch WRITTEN+BUILT+COMMITTED (9 profiles: tirzepatide, retatrutide, phenazolam, etonitazepyne, para-fluorofentanyl, btmps, o-dsmt, bupropion, ssris-snris → 446 total; inbound related links wired; formulas added; repo main bec65aa41a) but NOT yet deployed — one-time cron 2026-09-23 ~15:00 UTC triggers build + KV seed + wrangler deploy + live verify. Live site still serves f7630af9 until then. · Read this first in any new session before touching anything.
